(() => {
    ...
    function initSliders() {
        if (document.querySelector(".implementation__slider")) new swiper_core_Swiper(".implementation__slider", {
            ...
            speed: 800,
            navigation: {
                prevEl: ".implementation-button-prev",
                nextEl: ".implementation-button-next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
        ...
        if (document.querySelector(".implementation__slider-sec")) new swiper_core_Swiper(".implementation__slider-sec", {
